...
lil_cheese = Burger.create(name: "Little Cheeseburger", description: "Like our regular cheeseburger, just one grilled to order, hand-crafted patty instead of two.", image_url: "https://s-media-cache-ak0.pinimg.com/736x/85/c7/6b/85c76bed523b6eff356a3d3f4ef1a292.jpg", price: "5.69", restaurant: five_guys, user: user)
...
dbl_stack = Burger.create(name: "Double Stack", description: "Big on taste and small on price, delicious!", image_url: "http://www.restaurantmagazine.com/wp-content/uploads/2017/01/Wendys-Beefs-Up-4-for-4-Meal-with-Double-Stack-feeature.jpg", price: "2.09", restaurant: wendys, user: genie)
